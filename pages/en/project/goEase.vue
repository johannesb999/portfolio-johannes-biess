        ...
        <div class="project-content">
          <div class="text">
            ...
            <div class="paragraph">
              ...
              challenges.<br> There are lots of different bus companies and
              associations, each with their own fare systems. Often, there isn't
              a good app solution or none at all.<br> Passengers, especially those
              ...
              the right fare. <br>On top of that, the ticket machines are often
              ...
              many passengers.<br> The idea for GoEase came from thinking about how
              we could make local public transport more accessible and
              convenient. The idea behind GoEase is a beacon system that can be
              easily added to buses throughout Germany. <br>Combined with a mobile
        ...
        <div class="project-content">
          ...
          <div class="text">
            ...
            <div class="paragraph">
              ...
              initial concepts.<br> Our initial vision was pretty ambitious. We
              ...
              public transport, not just buses. <br>That means trains, buses, planes
              and ships too. <br><br>This first idea included lots of different features
              ...
              of the core idea.<br> All these planned features made the project look
              ...
              to think about other interfaces.<br> This focus helped us make the
        ...
        <div class="project-content">
          ...
          <div class="text">
            <div class="paragraph">
              ...
              us use it on different platforms.<br> <br/>We chose React Native because it
              lets the app talk to the beacons via BLE. <br>We made sure to get the
              ...
              iterative.<br/> Once we had the first functional prototypes up and
              ...
              We wanted it to be quick and easy for the user. <br/>Once you've set up
              ...
              costs have already been debited.<br/> This way, you're always in the
              know and in control.
            </div>
          </div>
        </div>
        ...
        <div class="project-content">
          ...
          <div class="text">
            <div class="paragraph">
              ...
              buckle to the housing so it can be mounted on various poles. <br/><br/>This
              was a smaller step than the software development, but it was
              crucial to create the technical basis for the entire system and
              ensure smooth functionality in everyday use.
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="project-content">
          <div class="text">
            ...
            <div class="paragraph">
              ...
              convenient way to use public transport. <br/>Once you set up the app,
              it does all the heavy lifting in the background, making bus travel
              as easy and carefree as possible. The beacon, which is based on an
              ESP32 LilyGO, is designed to be integrated into existing buses and
              uses BLE to communicate with the app. This hardware is affordable,
              simple to install, and can be mounted in different ways on the bus
              to make it easy to use. With GoEase, you can buy tickets without
              even having to tap in. The app detects when you board, records the
              distance traveled, and calculates the fare—all without you having
              to do a thing.<br/> While you're on your journey, you can check in on
              your progress and see what your costs are. For passengers, this
              means maximum convenience and transparency. <br/>The idea behind GoEase
              is to make things simple.<br> We've got rid of all the unnecessary
              steps that often make public transport complicated and
              unattractive. No complex fare systems or unreliable ticket
              machines—just a simple, intuitive solution that makes public
              transport more accessible and lowers barriers to entry. GoEase is
              a great way to use public transport, especially for people who
              don't use it all the time. It's also a better, more future-proof
