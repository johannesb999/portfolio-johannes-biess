    ...
    <main>
      ...
      <div class="project-details">
        ...
        <div class="project-header">
          <h1 class="project-title"><span>UZHJHASGBVSAIJUDAUD</span>SIMPLECHAT<span>HGBBVSAIHJTJGEUMJAUD</span></h1>
        ...
        <div class="project-section">
          <div class="project-content">
            <div class="text">
              ...
              <p>
                The university's current communication platform, Slack, is to be changed. Therefore, the task is to create an own platform that enables or even improves the communication between the university, students and alumni.
              </p>
            </div>
            <div class="image">
